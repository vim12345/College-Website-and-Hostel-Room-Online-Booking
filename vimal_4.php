    ...
    <header id="header">
        ...
        <nav class="main-menu top-menu">
            <ul>
                ...
                <li class="active"><a href="vimal_4.php">Contact Us</a></li>                
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row contact-info">
                        <div class="col-md-4">
                            <div class="info-item">
                                <p><i class="fa fa-map-marker"></i>Rajkiya Engineering College Rd, Churk, Uttar Pradesh
                                    231206</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-item">
                                <p><i class="fa fa-envelope"></i> <a
                                        href="mailto:info@example.com">RECcollege@gamil.com</a></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-item">
                                <p><i class="fa fa-phone"></i><a href="tel:+1 234 567 8900">05444-252002</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="control-group">
                                ...
                                <textarea class="form-control" id="message" rows="5"
                                    placeholder="write here" required="required"
