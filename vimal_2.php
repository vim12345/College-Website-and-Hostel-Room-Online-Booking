        ...
        <nav class="main-menu top-menu">
            <ul>
             <li><a href="index.php">Home</a></li>
                ...
                <li class="active"><a href="vimal_2.php">Rooms</a></li>
                <li><a href="vimal_3.php">Amenities</a></li>
                <li><a href="vimal_4.php">Contact Us</a></li>
                <li><a href="king.php">Login</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="room-des">
                                <h3><a href="#" data-toggle="modal" data-target="#modal-id">Hostel-1</a></h3>
                        ...
                        <div class="col-md-3">
                            <div class="room-rate">
                                <h3>From</h3>
                                <h1>FOR BOYS</h1>
                                <a href="/rec/hostel/hostel1/index.php">Book Now</a>
                            </div>
                        </div>
                    </div>
                    <hr>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="room-img">
                                <div class="box12">
                                    <img src="img/room/room-2.jpeg">
                                    <div class="box-content">
                                        <h3 class="title">Hostel-2</h3>
                                        <ul class="icon">
                                            <li><a href="#" data-toggle="modal" data-target="#modal-id"><i
                                                        class="fa fa-link"></i></a></li>
                                        </ul>
                        ...
                        <div class="col-md-6">
                            <div class="room-des">
                                <h3><a href="#" data-toggle="modal" data-target="#modal-id">Hostel-2</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                <ul class="room-size">
                        ...
                        <div class="col-md-3">
                            <div class="room-rate">
                                <h3>From</h3>
                                <h1>FOR BOYS</h1>
                                <a href="/rec/hostel/hostel2/index.php">Book Now</a>
                            </div>
                        </div>
                    </div>
                    <hr>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="room-des">
                                <h3><a href="#" data-toggle="modal" data-target="#modal-id">Hostel-3</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                <ul class="room-size">
                        ...
                        <div class="col-md-3">
                            <div class="room-rate">
                                <h3>From</h3>
                                <h1>FOR BOYS</h1>
                                <a href="/rec/hostel/hostel3/index.php">Book Now</a>
                            </div>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="room-rate">
                                <h3>From</h3>
                                <h1>FOR GIRL</h1>
                                <a href="/rec/hostel/hostelg1/index.php">Book Now</a>
                            </div>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="modal-link">
                                <a href="href="/rec/hostel/index.php"">Book Now</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <p>Copyright &#169; 2045 <a href="">REC Hostel</a> All Rights Reserved.</p>

                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    <p>Designed By <a href="http://recsonbhadra.ac.in/">REC SONBHADRA</a></p>
                </div>
            </div>
        </div>
    </div>
